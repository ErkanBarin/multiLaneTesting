...
- `orchestration/` Robot suites + `osdr_process`-style resource; `docs/ci/robot-orchestration.md`.
...
- Passes the `osdr-pr-hygiene`-style checklist (`.claude/skills/pr-hygiene`).
